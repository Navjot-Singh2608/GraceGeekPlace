			...
			link: function ($scope, element, attrs) {
				...
				*/
				amse.on_data_change_fn = function () {
					...
					$rootScope.outputModel = $scope.outputModel;
					$timeout(function () {
				...
				*/
				...
				$rootScope.updateSkills = function(_new){
					/*DataConverter.prototype.check_prerequisites(_new)*/
				};

				$scope.$watch('inputModel', function (_new, _old) {
					console.log("here is angularjs");
					console.log(_new);
