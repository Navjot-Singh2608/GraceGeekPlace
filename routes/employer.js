...
exports.getAllEmployersDetails = function (req, res) {
    db.collection(collectionName, function (err, collection) {
...
exports.saveEmployerProfile = function (req, res) {
    var item = req.body;
    db.collection(collectionName, function (err, collection) {
...
exports.updateEmployerProfile = function (req, res) {
