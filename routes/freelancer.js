...
exports.getAllFreelancerProfiles = function (req, res) {
    db.collection(collectionName, function (err, collection) {
...
exports.saveFreelancerProfile = function (req, res) {
    var item = req.body;
    db.collection(collectionName, function (err, collection) {
...
exports.updateFreelancerProfile = function (req, res) {
    var email = req.params.id;
    var appItem = req.body;
    console.log("skills");
    console.log(req.params);
    var collection = db.collection("freelancer");
