...
export interface IVisualization {
    update(props: IVisProps, visualizationProperties: IVisualizationProperties, mdObject: VisualizationObject.IVisualizationObjectContent, references: IReferences): void;
    unmount(): void;
