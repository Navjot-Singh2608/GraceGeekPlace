...
import { IReferencePoint, IExtendedReferencePoint, IVisConstruct, IVisualizationProperties, IVisProps, IUiConfig, IGdcConfig } from "../../../interfaces/Visualization";
...
export declare class PluggableGeoPushpinChart extends PluggableBaseChart {
    ...
    protected buildVisualizationConfig(mdObject: VisualizationObject.IVisualizationObjectContent, config: IGdcConfig, supportedControls: IVisualizationProperties): IChartConfig;
