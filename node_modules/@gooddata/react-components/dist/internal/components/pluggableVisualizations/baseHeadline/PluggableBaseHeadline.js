...
var PluggableBaseHeadline = /** @class */ (function (_super) {
    ...
    PluggableBaseHeadline.prototype.renderConfigurationPanel = function (visualizationProperties) {
        if (document.querySelector(this.configPanelElement)) {
            ...
            react_dom_1.render(React.createElement(UnsupportedConfigurationPanel_1.default, { locale: this.locale, pushData: this.callbacks.pushData, properties: propertiesHelper_1.getSupportedProperties(properties, this.supportedPropertiesList) }), document.querySelector(this.configPanelElement));
        }
    };
