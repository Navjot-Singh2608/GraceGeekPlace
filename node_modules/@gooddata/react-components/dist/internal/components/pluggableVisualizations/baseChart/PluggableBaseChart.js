...
var PluggableBaseChart = /** @class */ (function (_super) {
    ...
    PluggableBaseChart.prototype.renderVisualization = function (options, visualizationProperties, mdObject) {
        ...
        if (dataSource) {
            ...
            var allProperties = get(visualizationProperties, "properties", {});
    ...
    PluggableBaseChart.prototype.getLegendPosition = function (controlProperties, mdObject) {
        ...
        if (legendPosition === "auto") {
            ...
            if (this.type === "heatmap") {
                return this.environment === properties_1.DASHBOARDS_ENVIRONMENT ? "right" : "top";
            }
            return mdObjectHelper_1.isStacked(mdObject) || this.environment === properties_1.DASHBOARDS_ENVIRONMENT ? "right" : "auto";
        }
