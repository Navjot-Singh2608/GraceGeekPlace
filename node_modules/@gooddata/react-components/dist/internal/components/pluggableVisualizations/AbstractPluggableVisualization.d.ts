...
import { IReferencePoint, IExtendedReferencePoint, IVisualization, IBucketItem, IVisProps, IVisualizationProperties, IBucket, IReferences } from "../../interfaces/Visualization";
export declare abstract class AbstractPluggableVisualization implements IVisualization {
    ...
    abstract update(props: IVisProps, visualizationProperties: IVisualizationProperties, mdObject: IVisualizationObjectContent, references: IReferences): void;
