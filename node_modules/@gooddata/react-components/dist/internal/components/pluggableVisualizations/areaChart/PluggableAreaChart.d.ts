...
import { IReferencePoint, IExtendedReferencePoint, IVisConstruct, IUiConfig, IVisProps, IVisualizationProperties, IReferences } from "../../../interfaces/Visualization";
import { VisualizationObject } from "@gooddata/typings";
export declare class PluggableAreaChart extends PluggableBaseChart {
    constructor(props: IVisConstruct);
    getUiConfig(): IUiConfig;
    update(options: IVisProps, visualizationProperties: IVisualizationProperties, mdObject: VisualizationObject.IVisualizationObjectContent, references: IReferences): void;
