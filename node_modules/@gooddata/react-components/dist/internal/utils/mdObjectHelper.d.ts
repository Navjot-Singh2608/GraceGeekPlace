...
export declare function canSortStackTotalValue(mdObject: VisualizationObject.IVisualizationObjectContent, supportedControls: IVisualizationProperties, enableSortingByTotalGroup?: boolean): boolean;
...
export declare function countItemsOnAxes(type: string, controls: IVisualizationProperties, mdObject: VisualizationObject.IVisualizationObjectContent): {
    yaxis: number;
    xaxis: number;
    secondary_xaxis: any;
