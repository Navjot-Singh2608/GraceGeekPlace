...
var PresetsDropdown = /** @class */ (function (_super) {
    ...
    PresetsDropdown.prototype.render = function () {
        ...
        return (React.createElement(Overlay_1.default, { closeOnOutsideClick: true, closeOnParentScroll: true, alignTo: anchorEl, alignPoints: utils_1.positioningToAlignPoints(positioning), onClose: onClose },
