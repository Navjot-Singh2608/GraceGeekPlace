...
var FormatTemplatesDropdown = /** @class */ (function (_super) {
    ...
    FormatTemplatesDropdown.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "gd-measure-format-templates" },
            ...
            isOpened && (React.createElement(Overlay_1.default, { closeOnOutsideClick: true, closeOnParentScroll: true, alignTo: ".gd-measure-custom-format-dialog-section-title", alignPoints: [{ align: "br tr" }], onClose: this.closeDropdown },
