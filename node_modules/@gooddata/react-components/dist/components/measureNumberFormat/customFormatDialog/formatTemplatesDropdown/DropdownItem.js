...
var DropdownItem = /** @class */ (function (_super) {
    ...
    DropdownItem.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            displayHelp && (React.createElement(Bubble_1.default, { alignTo: "#" + templateDropdownItemId(template), className: "gd-measure-format-template-preview-bubble bubble-light s-measure-format-template-help-bubble-" + js_utils_1.string.simplifyText(template.name), alignPoints: [{ align: "cr cl" }] },
