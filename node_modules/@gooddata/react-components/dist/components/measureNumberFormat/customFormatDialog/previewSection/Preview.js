        ...
        _this.render = function () {
            ...
            return (React.createElement("div", { className: "gd-measure-custom-format-dialog-section gd-measure-custom-format-dialog-section-preview" },
                ...
                React.createElement("div", { className: "gd-measure-custom-format-dialog-preview" },
                    ...
                    React.createElement("div", { className: "s-custom-format-dialog-preview-formatted gd-measure-custom-format-dialog-preview-string" },
                        React.createElement(FormattedPreview_1.FormattedPreview, { previewNumber: _this.state.preview, format: format, separators: separators }))),
