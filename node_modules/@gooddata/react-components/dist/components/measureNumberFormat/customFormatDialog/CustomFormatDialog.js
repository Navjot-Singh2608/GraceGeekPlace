...
var CustomFormatDialog = /** @class */ (function (_super) {
    ...
    CustomFormatDialog.prototype.render = function () {
        ...
        return (React.createElement(Overlay_1.default, { closeOnParentScroll: true, alignTo: anchorEl, alignPoints: utils_1.positioningToAlignPoints(positioning), onClose: onCancel },
            React.createElement("div", { className: "gd-dropdown overlay" },
                React.createElement("div", { className: "gd-measure-custom-format-dialog-body s-custom-format-dialog-body" },
                    React.createElement("div", { className: "gd-measure-custom-format-dialog-header" },
                        ...
                        React.createElement("div", { className: "gd-dialog-close" },
                            React.createElement(Button_1.default, { className: "gd-button-link gd-button-icon-only icon-cross s-dialog-close-button", value: "", onClick: onCancel }))),
