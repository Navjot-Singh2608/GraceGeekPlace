...
exports.WATCHING_TABLE_RENDERED_MAX_TIME = 15000;
...
var PivotTableInner = /** @class */ (function (_super) {
    ...
    function PivotTableInner(props) {
        ...
        _this.waitingForFirstExecution = true;
        //
        ...
        _this.getAutoResizedColumns = function (columns) {
            return columns.reduce(function (acc, col) {
                ...
                return __assign({}, acc, (_a = {}, _a[columnId] = {
                    ...
                    source: PivotTable_1.ColumnEventSourceType.AUTOSIZE_COLUMNS,
                }, _a));
            }, _this.autoResizedColumns);
        };
        _this.addToManuallyResizedColumn = function (column) {
            _this.manuallyResizedColumns[agGridUtils_1.getColumnIdentifier(column)] = {
                width: column.getActualWidth(),
                source: PivotTable_1.ColumnEventSourceType.UI_DRAGGED,
            };
            column.getColDef().suppressSizeToFit = true;
        };
        _this.removeFromManuallyResizedColumn = function (column) {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                ...
                                                return [4 /*yield*/, this.autoresizeColumnsByColumnId(columnApi, newColumnIds)];
                                            case 1:
                                                _a.sent();
        ...
        _this.autoresizeColumns = function (event, force, previouslyResizedColumnIds) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var alreadyResized, noRowHeadersOrRows, dataRendered, tablePagesLoaded, columns;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            alreadyResized = function () { return _this.state.resized || _this.resizing; };
                            noRowHeadersOrRows = function (executionResult) {
                            ...
                            dataRendered = function () {
                                ...
                                return (noRowHeadersOrRows(executionResult) ||
                                    (executionResult && event.api.getRenderedNodes().length > 0));
                            };
                            tablePagesLoaded = function () {
                                var pages = event.api.getCacheBlockState();
                                return (pages &&
                            ...
                            if (!(this.state.execution &&
                                tablePagesLoaded() &&
                                dataRendered() &&
                                (!alreadyResized() || (alreadyResized() && force)))) return [3 /*break*/, 2];
                            this.resizing = true;
        ...
        _this.onModelUpdated = function (event) { return __awaiter(_this, void 0, void 0, function () {
            var shouldAutoresizeColumns, growToFit;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        shouldAutoresizeColumns = this.isColumnAutoresizeEnabled() && this.getExecution();
                        growToFit = this.isGrowToFitEnabled() && this.getExecution();
                        if (!(shouldAutoresizeColumns || growToFit)) return [3 /*break*/, 2];
        ...
        _this.startWatchingTableRendered = function () {
            ...
            var isTableVisible = !_this.isTableHidden(); // table has data and takes place of Loading icon
        ...
        _this.stopWatchingTableRendered = function () {
            ...
            clearTimeout(_this.watchingTimeoutId);
            _this.watchingTimeoutId = null;
        ...
        _this.onFirstDataRendered = function () {
            ...
            if (!_this.watchingTimeoutId) {
                // onFirstDataRendered can be called multiple times
                _this.watchingTimeoutId = window.setTimeout(_this.stopWatchingTableRendered, exports.WATCHING_TABLE_RENDERED_MAX_TIME);
            }
        };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.isManualResizing(columnEvent)) return [3 /*break*/, 6];
                        if (!this.hasColumnWidths()) return [3 /*break*/, 5];
        ...
        _this.onColumnsManualReset = function (columns) { return __awaiter(_this, void 0, void 0, function () {
            var execution, _i, columns_1, column;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        execution = this.getExecution();
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(_i < columns_1.length)) return [3 /*break*/, 4];
                        column = columns_1[_i];
        ...
        _this.onColumnsManualResized = function (columns) {
            var execution = _this.getExecution();
            invariant(execution !== undefined, "changing column width prior execution cannot work");
            columns.forEach(function (column) {
                _this.addToManuallyResizedColumn(column);
            });
        ...
        _this.preventHeaderResizerEvents = function (event) {
    ...
    PivotTableInner.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        new Promise(function (resolve) {
            ...
            var dataSourceChanged = _this.props.dataSource.getFingerprint() !== prevProps.dataSource.getFingerprint();
            ...
            var prevColumnWidths = _this.getColumnWidths(prevProps);
            var columnWidths = _this.getColumnWidths(_this.props);
            if (!isEqual(prevColumnWidths, columnWidths)) {
                if (_this.columnApi) {
                    var columnWidthsByField = agGridColumnSizing_1.convertColumnWidthsToMap(columnWidths, _this.getExecutionResponse());
                    agGridColumnSizing_1.syncSuppressSizeToFitOnColumns(_this.manuallyResizedColumns, columnWidthsByField, _this.columnApi);
                    _this.manuallyResizedColumns = columnWidthsByField;
                    if (_this.isGrowToFitEnabled()) {
                        _this.growToFit(_this.columnApi); // calls resetColumnsWidthToDefault internally too
                    }
                    else {
                        var columns = _this.columnApi.getAllColumns();
                        _this.resetColumnsWidthToDefault(_this.columnApi, columns);
                    }
                }
            }
        });
    ...
    PivotTableInner.prototype.isColumnManuallyResized = function (resizedColumnId) {
        return agGridColumnSizing_1.isColumnManuallyResized(this.manuallyResizedColumns, resizedColumnId);
    };
    PivotTableInner.prototype.resetColumnsWidthToDefault = function (columnApi, columns) {
        agGridColumnSizing_1.resetColumnsWidthToDefault(columnApi, columns, this.manuallyResizedColumns, this.autoResizedColumns, this.getDefaultWidth());
    };
    ...
    PivotTableInner.prototype.setFittedColumns = function (columnApi) {
        ...
        columns.forEach(function (col) {
            ...
            _this.growToFittedColumns[id] = {
                width: col.getActualWidth(),
                source: PivotTable_1.ColumnEventSourceType.FIT_GROW,
            };
        });
    };
    ...
    PivotTableInner.prototype.createAGGridDataSource = function () {
        ...
        var onSuccess = function (execution, columnDefs, resultSpec) {
            var enrichedColumnDefs = agGridColumnSizing_1.enrichColumnDefinitionsWithWidths(columnDefs, _this.manuallyResizedColumns, _this.autoResizedColumns, _this.getDefaultWidth(), _this.isGrowToFitEnabled(), _this.growToFittedColumns);
            if (!isEqual(enrichedColumnDefs, _this.state.columnDefs)) {
                ...
                if (_this.waitingForFirstExecution) {
                    _this.waitingForFirstExecution = false;
                    var columnWidths = _this.getColumnWidths(_this.props);
                    var columnWidthsByField = agGridColumnSizing_1.convertColumnWidthsToMap(columnWidths, execution.executionResponse);
                    _this.manuallyResizedColumns = columnWidthsByField;
                    enrichedColumnDefs = agGridColumnSizing_1.enrichColumnDefinitionsWithWidths(columnDefs, columnWidthsByField, _this.autoResizedColumns, _this.getDefaultWidth(), _this.isGrowToFitEnabled(), _this.growToFittedColumns);
                }
                _this.setState({
    ...
    PivotTableInner.prototype.resetResizedColumn = function (column) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = agGridUtils_1.getColumnIdentifier(column);
                        if (this.isColumnManuallyResized(id)) {
                            this.removeFromManuallyResizedColumn(column);
                        }
                        if (!this.isColumnAutoResized(id)) return [3 /*break*/, 1];
                        this.columnApi.setColumnWidth(column, this.autoResizedColumns[id].width);
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.autoresizeColumnsByColumnId(this.columnApi, this.getColumnIds([column]))];
                    case 2:
                        _a.sent();
    ...
    PivotTableInner.prototype.afterOnResizeColumns = function () {
        ...
        var columnWidths = agGridColumnSizing_1.getColumnWidthsFromMap(this.manuallyResizedColumns, execution);
