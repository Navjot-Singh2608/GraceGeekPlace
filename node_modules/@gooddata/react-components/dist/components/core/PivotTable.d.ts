...
export declare const WATCHING_TABLE_RENDERED_MAX_TIME = 15000;
...
export declare class PivotTableInner extends BaseVisualization<IPivotTableInnerProps, IPivotTableState> {
    ...
    private addToManuallyResizedColumn;
    private removeFromManuallyResizedColumn;
    ...
    private isColumnManuallyResized;
    ...
    private preventHeaderResizerEvents;
