...
var VisualizationWrapped = /** @class */ (function (_super) {
        ...
        switch (type) {
            case visualizationTypes_1.VisualizationTypes.TABLE: {
                ...
                var pivotTableColumnProps = {
                    config: __assign({}, config, featureFlags_1.getTableConfigFromFeatureFlags(this.state.featureFlags)),
                };
    ...
    VisualizationWrapped.prototype.prepareDataSources = function (projectId, identifier, filters) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _a, uriResolver, fetchVisObject, fetchVisualizationClass, locale, getFeatureFlags, _b, visualizationUri, featureFlags, localeFromUserAccount, mdObject, visualizationClassUri, visualizationClass, visualizationType, mdObjectContent, mdObjectContentProperties, secondaryYAxis, canSortStackTotalValue, sortingConfigs, _c, afm, resultSpec, mdObjectTotals, dataSource;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 4:
                        ...
                        mdObjectContent = mdObject.content;
                        mdObjectContentProperties = mdObjectContent && mdObjectContent.properties && JSON.parse(mdObject.content.properties);
    ...
    VisualizationWrapped.prototype.createVisualizationConfig = function () {
        ...
        var mdObjectContent = mdObject && mdObject.content;
        return featureFlags_1.setConfigFromFeatureFlags(mergeChartConfigWithProperties(config, mdObjectContent, colorPalette, featureFlags), featureFlags);
    };
...
function buildAfmResultSpec(visObj, visType, locale, sortingConfigs) {
    ...
    var genericAfmResultSpec = toAfmResultSpec(updatedVisObj);
...
function mergeChartConfigWithProperties(config, visObj, fallbackPalette, featureFlags) {
    var properties = visObj && visObj.properties && JSON.parse(visObj.properties).controls;
    var colorPalette = config && config.colorPalette ? config.colorPalette : fallbackPalette;
    var colorMapping = properties && properties.colorMapping
        ? properties.colorMapping.map(function (mapping) {
        ...
        : undefined;
    var propsWithHCAxisNameConfig = propertiesHelper_1.getHighchartsAxisNameConfiguration(properties, featureFlags.enableAxisNameConfiguration);
    return __assign({}, propsWithHCAxisNameConfig, { colorMapping: colorMapping }, config, { colorPalette: colorPalette, mdObject: visObj });
}
