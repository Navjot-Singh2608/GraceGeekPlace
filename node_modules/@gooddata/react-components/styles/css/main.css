...
.gd-measure-custom-format-dialog-body {
  ...
  .gd-measure-custom-format-dialog-body .gd-measure-custom-format-dialog-header {
    ...
    .gd-measure-custom-format-dialog-body .gd-measure-custom-format-dialog-header > span {
      ...
      font-size: 11px;
      font-weight: bold; }
    .gd-measure-custom-format-dialog-body .gd-measure-custom-format-dialog-header .gd-dialog-close {
      flex: 0 0 auto; }
      .gd-measure-custom-format-dialog-body .gd-measure-custom-format-dialog-header .gd-dialog-close > button {
        width: 21px;
        height: 21px; }
...
.gd-measure-format-extended-preview-row {
  display: flex;
  line-height: 20px; }
  .gd-measure-format-extended-preview-row span {
    white-space: nowrap; }
