...
function filterMenuItems(menuItems) {
  ...
  return menuItems.map(function (item) {
    ...
    var isVisible = item.isVisible,
        rest = (0, _objectWithoutProperties2["default"])(item, ["isVisible"]);
    return rest;
  });
}
  ...
  (0, _createClass2["default"])(Header, [{
    ...
    value: function renderLogoutButton() {
      ...
      return logoutMenuItem ? _react["default"].createElement(_Button["default"], {
        ...
        onClick: function onClick() {
          _this4.props.onMenuItemClick(logoutMenuItem);
        }
      }) : false;
    }
  }, {
    ...
    value: function renderStandardNav() {
      ...
      }), !!this.props.helpMenuItems.length && _react["default"].createElement(_HeaderHelp["default"], {
        onMenuItemClick: this.props.onMenuItemClick,
...
function generateHeaderMenu(bootstrapData, options) {
  ...
  var isDashboardVisible = projectId && permissions.canAccessWorkbench === "1" && shouldShowPPExperience;
  var isReportVisible = projectId && permissions.canManageReport === "1" && shouldShowPPExperience;
  var headerMenuSections = [[{
    ...
    isVisible: projectId && (analyticalDashboards.length || permissions.canCreateAnalyticalDashboard === "1" && enableAnalyticalDashboards)
  }, {
    key: "gs.header.analyze",
    className: "s-menu-analyze",
    href: "/analyze/#/".concat(projectId, "/reportId/edit"),
    isVisible: projectId && permissions.canCreateVisualization === "1" && analyticalDesigner
  }, {
    key: "gs.header.load",
    className: "s-menu-load",
    href: "/data/#/projects/".concat(projectId, "/datasets"),
    isVisible: projectId && permissions.canUploadNonProductionCSV === "1" && enableCsvUploader
  }], [{
    key: "gs.header.manage",
    className: "s-menu-manage",
    href: "/#s=/gdc/projects/".concat(projectId, "|dataPage|"),
    isVisible: projectId && permissions.canManageMetric === "1"
  }]];
