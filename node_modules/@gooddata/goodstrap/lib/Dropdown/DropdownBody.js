  ...
  (0, _createClass2["default"])(DropdownBody, [{
    ...
    value: function renderList() {
      var _this$props6 = this.props,
          ...
          searchString = _this$props6.searchString,
          noData = _this$props6.noData,
          List = _this$props6.List,
          closeDropdown = _this$props6.closeDropdown,
          ...
          listProps = (0, _objectWithoutProperties2["default"])(_this$props6, ["intl", "className", "isLoading", "isMobile", "searchString", "noData", "List", "closeDropdown", "onSelect", "onScrollStart", "maxVisibleItemsCount", "items", "rowItem", "itemHeight", "mobileItemHeight", "height", "width", "scrollToSelected"]); // FIXME pick only relevant props for list
