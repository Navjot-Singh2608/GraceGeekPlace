...
var HeaderCore = /*#__PURE__*/function (_Component) {
  ...
  function HeaderCore(props) {
    ...
    _this.toggleOverlayMenu = function (isOverlayMenuOpen) {
      _this.setState({
        isOverlayMenuOpen: isOverlayMenuOpen
      });
    };

    _this.addHelpItemGroup = function (itemGroups, documentationUrl) {
      return !documentationUrl ? itemGroups : [].concat((0, _toConsumableArray2["default"])(itemGroups), [[{
        key: "gs.header.help",
    ...
    _this.renderMobileNav = function () {
      ...
      return [_react["default"].createElement("div", {
        ...
        onClick: function onClick() {
          _this.toggleOverlayMenu(!_this.state.isOverlayMenuOpen);
        }
    ...
    _this.renderVerticalMenu = function () {
      var menuItemsGroups = _this.addHelpItemGroup(_this.props.menuItemsGroups, _this.props.documentationUrl);

      return _this.state.isOverlayMenuOpen ? _react["default"].createElement("div", {
        key: "overlay-menu",
      ...
      }, _this.props.userName)), _react["default"].createElement("div", null, _this.renderLogoutButton()))) : false;
    };
    ...
    _this.renderLogoutButton = function () {
      ...
      return logoutMenuItem ? _react["default"].createElement(_Button["default"], {
        ...
        onClick: function onClick() {
          _this.props.onMenuItemClick(logoutMenuItem);
        }
      }) : false;
    };
